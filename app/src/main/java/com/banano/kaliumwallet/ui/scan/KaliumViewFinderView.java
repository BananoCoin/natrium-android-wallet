...
public class KaliumViewFinderView extends View implements IViewFinder {
    ...
    public KaliumViewFinderView(Context context) {
        super(context);
        this.mDefaultMaskColor = this.getResources().getColor(R.color.white_60);
        this.mDefaultBorderColor = this.getResources().getColor(R.color.white_90);
    ...
    public KaliumViewFinderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mDefaultMaskColor = this.getResources().getColor(R.color.white_60);
        this.mDefaultBorderColor = this.getResources().getColor(R.color.white_90);
        this.mDefaultBorderStrokeWidth = this.getResources().getInteger(me.dm7.barcodescanner.core.R.integer.viewfinder_border_width);
